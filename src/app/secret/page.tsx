...
//           <div className="mb-8">
//             {/* <h1 className="text-2xl text-neutral-800 font-semibold mb-1">
...
//           </div>
//         </div>
//         <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 gap-x-1">
//           <motion.button
//             onClick={() => {
//               if (nextRef.current) {
//                 window.scrollTo({
...
//               DANTE
//             </h1>
//             <p className="text-xl font-light text-neutral-800">
//               <i>[dan-tee]</i> (n.) - an AI-companion tailored with user preferences to vibe with you, understand you, support you, or just sit there and listen.
//             </p>
//             <br />
//             <p className="text-md font-light text-neutral-800 italic">
...
//             </h1>
//           </span> */}
//           <span className="w-1/2 place-content-center align-center text-center">
//             <p className="text-sm font-light text-neutral-200">
//               contact my mentor <a href="https://www.instagram.com/tony.tts_" className="hover:underline cursor-pointer">here!</a>
//             </p>
//           </span >
//         </div>
//       </div>
